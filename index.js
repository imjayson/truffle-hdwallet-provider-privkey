...
function HDWalletProvider(privateKeys, providerUrl, options) {
  ...
  this.engine.addProvider(new ProviderSubprovider(new Web3.providers.HttpProvider(providerUrl), options));
